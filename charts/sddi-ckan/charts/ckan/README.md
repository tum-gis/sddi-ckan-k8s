...
| volumeMounts | list | `[{"mountPath":"{{ .Values.persistence.storagePath }}","name":"data","readOnly":false}]` | Sets [`volumeMounts`](https://kubernetes.io/docs/concepts/storage/volumes). Set to `[]` to disable the default volumeMounts. Set to any list of volumeMount definitions to overwrite the default volumeMounts. Use `extraVolumeMounts` to extend the default volumeMounts. |
| volumes | list | `[{"name":"data","persistentVolumeClaim":{"claimName":"{{ include \"ckan.fullname\" . }}"}}]` | Sets [`volumes`](https://kubernetes.io/docs/concepts/storage/volumes). Set to `[]` to disable the default volumes. Set to any list of volume definitions to overwrite the default volumes. Use `extraVolumes` to extend the default volumes. |
